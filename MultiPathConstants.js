...
exports.DECIMAL_BONK_MULTIPLIER = exports.DECIMAL_SOL_MULTIPLIER = exports.DECIMAL_USDC_MULTIPLIER = exports.DECIMAL_100 = exports.DECIMAL_ONE = exports.DECIMAL_ZERO = exports.RISK_PARAMS = exports.ALL_POOLS = exports.BONK_DECIMALS = exports.SOL_DECIMALS = exports.USDC_DECIMALS = exports.BONK_MINT = exports.SOL_MINT = exports.USDC_MINT = void 0;
exports.getPoolsByPair = getPoolsByPair;
exports.getUSDCSOLPools = getUSDCSOLPools;
exports.getSOLBONKPools = getSOLBONKPools;
exports.getUSDCBONKPools = getUSDCBONKPools;
 ...
 */
function getPoolsByPair(tokenA, tokenB) {
    return exports.ALL_POOLS.filter(p => (p.tokenA === tokenA && p.tokenB === tokenB) ||
        (p.tokenA === tokenB && p.tokenB === tokenA));
}
/**
 * Get all USDC/SOL pools
 */
function getUSDCSOLPools() {
    return getPoolsByPair(exports.USDC_MINT, exports.SOL_MINT);
}
/**
 * Get all SOL/BONK pools
 */
function getSOLBONKPools() {
    return getPoolsByPair(exports.SOL_MINT, exports.BONK_MINT);
}
/**
 * Get all USDC/BONK pools
 */
function getUSDCBONKPools() {
    return getPoolsByPair(exports.USDC_MINT, exports.BONK_MINT);
}
/**
 * Get minimum profit threshold for path type
 */
function getMinProfitThreshold(pathType) {
    switch (pathType) {
        case "1hop": return exports.RISK_PARAMS.MIN_PROFIT_1HOP;
        case "2hop": return exports.RISK_PARAMS.MIN_PROFIT_2HOP;
        case "3hop": return exports.RISK_PARAMS.MIN_PROFIT_3HOP;
        case "4hop": return exports.RISK_PARAMS.MIN_PROFIT_4HOP;
    }
}
/* =========================
   DECIMAL CONSTANTS

...
class GrpcFastScanner {
    ...
    checkArbitrageOptimized() {
        ...
        // ========================================
        const costPerSOL_dir1 = price005.mul(new decimal_js_1.default(1).plus(pool005.fee_rate)); // Buy on 0.05%
        const revenuePerSOL_dir1 = price001.mul(new decimal_js_1.default(1).minus(pool001.fee_rate)); // Sell on 0.01%
        ...
        // ========================================
        const costPerSOL_dir2 = price001.mul(new decimal_js_1.default(1).plus(pool001.fee_rate)); // Buy on 0.01%
        const revenuePerSOL_dir2 = price005.mul(new decimal_js_1.default(1).minus(pool005.fee_rate)); // Sell on 0.05%

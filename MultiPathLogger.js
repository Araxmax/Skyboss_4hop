...
exports.PoolPriceLogger = exports.MultiPathLogger = void 0;
...
class MultiPathLogger {
    constructor(logDir = "./logs/multipath") {
        this.logDir = logDir;
     ...
     */
    logScannerData(scanNumber, results) {
     ...
     */
    logTradeData(scanNumber, tradableResults) {
...
exports.MultiPathLogger = MultiPathLogger;
class PoolPriceLogger {
    constructor(logDir = "./logs/multipath") {
        this.logDir = logDir;
...
exports.PoolPriceLogger = PoolPriceLogger;
